...
- Renamed `app/bundle.js` to `dist/renderer/renderer.prod.js` for consistency
...
- **Renamed `./app/main.development.js` => `./dist/main.{dev,prod}.js`:** [#963](https://github.com/electron-react-boilerplate/electron-react-boilerplate/pull/963)
